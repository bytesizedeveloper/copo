...
public class TransactionResourceTest extends ObjectMapperBase {
    ...
    void testCreate_validRequest_returns201() {
        ...
        given()
                ...
                .body("sender_address", Matchers.equalTo(WalletTestData.ADDRESS_ALPHA.value()))
                .body("recipient_address", Matchers.equalTo(WalletTestData.ADDRESS_BETA.value()))
                .body("amount", Matchers.equalTo(10.0F))
                .body("fee", Matchers.equalTo(1.0F))
