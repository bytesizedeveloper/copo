...
import org.acme.common.utility.WalletUtility;
...
public class TransactionRequest {
    ...
    @Digits(integer = 9, fraction = 6, message = "Amount must not exceed 9 integral or 6 fractional digits.")
    @DecimalMin(value = "0.000001", message = "Amount must exceed or be equal to 0.000001.")
    ...
    public String toString() {
        String format = """
                [NOT_CALCULATED] | %s -> %s : %f #""";
        return format.formatted(this.senderAddress.substring(0, 21), this.recipientAddress.substring(0, 21), this.amount);
    }
